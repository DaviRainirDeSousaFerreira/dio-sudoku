...
public class UIMain {
    ...
    public static void main(String[] args) {
        ...
        // Novas linhas
        String data = "0,0;4,false 1,0;7,false 2,0;9,true 3,0;5,false 4,0;8,true 5,0;6,true 6,0;2,true 7,0;3,false 8,0;1,false "
        ...
        // Loop para adicionar ao map
        for (String entry : data.split(" ")) {
            String[] parts = entry.split(";");
            gameConfig.put(parts[0], parts[1]);
        }
